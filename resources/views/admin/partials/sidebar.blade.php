    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header">
            <div class="d-flex justify-content-between">
                <div class="logo">
                    <a href="index.html"><img src="{{asset('adminn/img/logo/logo.png')}}" alt="Logo" srcset=""></a>
                </div>
                <div class="toggler">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item">
                    <a href="{{route('assign.exam')}}" class="sidebar-link">
                ...
                <li class="sidebar-item">
                    <a href="{{route('view.exam')}}" class="sidebar-link">
                        <i class="bi bi-hexagon-fill"></i>
                        <span>Kullanıcı Sınavlarını Görüntüle</span>
                    </a>
                </li>

                <li class="sidebar-item">
                    <a href="{{route('result')}}" class='sidebar-link'>
